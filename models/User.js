...
const userSchema = new mongoose.Schema({
  ...
  medicalCertificate:         { type: String, default: '' },  // Base64
  medicalCertificateType:     { type: String, default: '' },  // mime type
  ...
  vrToken:        { type: String, default: '' },
  vrTokenExpiry:  { type: Date },
  vrSessions:     { type: Array, default: [] }
}, { timestamps: true });
